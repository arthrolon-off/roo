...
function postDate() {
    ...
    // Random time generator_____________________________________________________________TIME

    // let timeSpan = document.querySelector('.random-time');
    // let randomTime = () => {
    ...
    // let resultTime = randomTime();
    // timeSpan.innerText = resultTime;
}